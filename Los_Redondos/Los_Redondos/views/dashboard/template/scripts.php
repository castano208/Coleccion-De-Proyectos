   ...
   <script src="../../../assets/dashboard/vendors/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <!-- jQuery Sparklines -->
    <script src="../../../assets/dashboard/vendors/jquery-sparkline/dist/jquery.sparkline.min.js"></script>

    <!-- morris.js -->
    <script src="../../../assets/dashboard/vendors/raphael/raphael.min.js"></script>
    <script src="../../../assets/dashboard/vendors/morris.js/morris.min.js"></script>
