                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered" style="width:100%">
                      <div class="col-sm-6" style="padding-right: 10px;">
                        <a href="#agregarEmpleado" class="btn btn-secondary" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Nuevo Empleado</span></a>	
                      </div>
                      <thead>
                        <tr>
                          <th>TD</th>
                      ...
                      <?php 
                        ...
                        foreach ($listaEmpleados as $registro) { 
                          if ($registro["ID"] != 0) {?>
                            ...
                            <td>
                              <a href="#editarEmpleado<?php echo $registro['ID']; ?>" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                              <a href="#eliminarEmpleado<?php echo $registro['ID']; ?>" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                            </td>
                          </tr>
                          <?php 
                          // $identificador = $registro['ID'] ;
                          include('../template/modalesEmpleados.php'); ?>
                          <?php } 
                            }
                          ?>
