        ...
        <div class="container" style="text-align:center;">
            ...
            <h5 class="section-title ff-secondary text-center text-primary fw-normal">Carrito de compras</h5>
                ...
                <div class="card-group">
                    <div class="card">
                        <div id=""></div>
                    <form action="./eliminar_cantidad_al_producto.php" method="post">
                        <div class="card-body">
                            <h5 class="card-title">Eliminar</h5><br>
                            ...
                            <div>
                                ...
                                <h6 class="card-title" id="respuesta2">Indique los cambios deseados</h6>
                            </div> 
                        </div>
                    ...
                    <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Producto seleccionado</h5><br>
                        <div>
                            ...
                            <br><h6><?php echo  $seleccionadoI ; ?></h6><br>
                        </div>
                        <button type="button"class="btn-dark btn-sm px-2 py-0" id="Enviar2">Ver precio</button><br><br>  
                            <input type="hidden" name="id_producto"  value="<?php echo $id_producto;?>">
                            <button class="btn- px-1 py-1 btn-sm" style="background-color: #E78618 ; color: #FFFFFF ; border-color: #FFFFFF ; ">Eliminar Cantidad</button><br>
                        </form>               
                    </div>
                </div>
            </div>
